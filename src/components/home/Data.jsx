...
const Data = () => {
  return (
    <div className="home__data">
        <h1 className="home__title">Pun Pun
            <svg
                    width="36"
                    height="36"
                    viewBox="0 0 48 48"
        ...
        <h3 className="home__subtitle">Computer Science @ NUS</h3>
        <p className="home__description">
            Hi! I'm a penultimate year computer science student @ National University of Singapore. 
            I'm interested in SWE, ML, and Data Science. Feel free to connect!
        </p>
